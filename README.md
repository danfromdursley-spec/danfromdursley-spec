...
- 📱 **Battery Whisperer** — battery stress / ageing insights + simple, explainable metrics  
- 📊 **Revenue Floor** — realistic revenue plans (capacity-capped, assumption-audited, exportable evidence pack)  
- 🧠 **Signal Compression / Stress-Testing** — tools for noisy time-series (markets + operational data)
...
- No back-end, no external API calls — everything runs **client-side** for easy auditing
...
[🌠 QDS Binary Pulsar Constraint Lab · One-Button NEON — fast Yukawa envelope sanity sweep for binary pulsars]
 https://danfromdursley-spec.github.io/QDS-Physics-Labs-Demo/www/qds_pulsar_onebutton_neon.htmlhttps
...
- Bias to transparent assumptions, reproducible runs, and offline demos you can take into the room.
